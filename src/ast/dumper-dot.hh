...
namespace ast
{
    ...
    protected:
        template <typename T>
        void dump(const std::string &field, const T &t);
        template <typename T>
        void dump(const std::string &field, const T *t);
        template <typename T>
        void dump_list(const std::string &field, const T &e);
        template <typename T>
        void dump_def(const T &e) const;
        template <typename E>
        void dump_chunk(const E &e, const std::string &name);
        ...
        template <typename T>
        void node_html_field(const std::string &name, const T &content,
                             const std::string &sep = "");
        void node_html_one_port(const std::string &p);
        void node_html_ports(const std::vector<std::string> &ports = {});
        template <typename T>
        void node_html_port_list(const std::string &name, const T &list,
                                 bool chunk = false);
