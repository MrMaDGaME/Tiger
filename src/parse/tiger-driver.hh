...
namespace parse
{
    ...
    public:
        ...
        ast::CallExp *make_CallExp(const location &location, misc::symbol name,
        ...
        ast::ArrayExp *make_ArrayExp(const location &location,
                                     ast::NameTy *type_name, ast::Exp *size,
                                     ast::Exp *init) const;
        ...
        ast::AssignExp *make_AssignExp(const location &location, ast::Var *var,
                                       ast::Exp *exp) const;

        ast::IfExp *make_IfExp(const location &location, ast::Exp *test,
                               ast::Exp *thenclause,
        ...
        ast::WhileExp *make_WhileExp(const location &location, ast::Exp *test,
                                     ast::Exp *body) const;

        ast::ForExp *make_ForExp(const location &location, ast::VarDec *vardec,
                                 ast::Exp *hi, ast::Exp *body) const;

        ast::BreakExp *make_BreakExp(const location &location) const;

        ast::LetExp *make_LetExp(const location &location, ast::ChunkList *decs,
                                 ast::Exp *body) const;

        ast::OpExp *make_OpExp(const location &location, ast::Exp *left,
                               ast::OpExp::Oper oper, ast::Exp *right) const;

        ast::CastExp *make_CastExp(const location &location, ast::Exp *exp,
                                   ast::Ty *ty) const;

        ast::SimpleVar *make_SimpleVar(const location &location,
                                       misc::symbol name) const;

        ast::FieldVar *make_FieldVar(const location &location, ast::Var *var,
                                     misc::symbol name) const;
        ...
        template <class... T>
        ast::fields_type *make_fields_type(T... types) const;

        ast::Field *make_Field(const location &location, misc::symbol name,
                               ast::NameTy *type_name) const;

        ast::NameTy *make_NameTy(const location &location,
                                 misc::symbol name) const;
        ...
        ast::FieldInit *make_FieldInit(const location &location,
                                       misc::symbol name, ast::Exp *init) const;

        ast::ClassTy *make_ClassTy(const location &location, ast::NameTy *super,
                                   ast::ChunkList *decs) const;

        ast::VarChunk *make_VarChunk(const location &location) const;

        ast::VarDec *make_VarDec(const location &location, misc::symbol name,
                                 ast::NameTy *type_name, ast::Exp *init) const;
        ...
        template <class... T>
        ast::FunctionChunk *make_FunctionChunk(T... args);
    };
} // namespace parse
