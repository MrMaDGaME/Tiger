...
#ifndef YY_PARSE_LIBPARSE_HH_INCLUDED
# define YY_PARSE_LIBPARSE_HH_INCLUDED
// "%code requires" blocks.
#line 49 "parsetiger.yy"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    {
      // function_r
      char dummy1[sizeof (ast::CallExp*)];
        ...
        switch (this->kind ())
    {
      case symbol_kind::S_function_r: // function_r
        value.move< ast::CallExp* > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ast::CallExp*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ast::CallExp*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ast::ChunkList*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ast::ChunkList*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ast::Field*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ast::Field*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const ast::NameTy*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
      ...
      {}
#else
      basic_symbol (typename Base::kind_type t, const ast::Ty*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ast::TypeChunk*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ast::TypeChunk*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ast::TypeDec*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, ast::fields_type*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const ast::fields_type*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
    ...
    {
      case symbol_kind::S_function_r: // function_r
        value.copy< ast::CallExp* > (that.value);
        break;
...
switch (yykind)
    {
      case symbol_kind::S_function_r: // function_r
        value.template destroy< ast::CallExp* > ();
        break;
...
# if PARSEDEBUG
    ...
    , location (that.location)
  {
    ...
    {
      case symbol_kind::S_function_r: // function_r
        value.copy< ast::CallExp* > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case symbol_kind::S_function_r: // function_r
        value.move< ast::CallExp* > (YY_MOVE (s.value));
        break;
...
#line 2768 "libparse.hh"


// "%code provides" blocks.
#line 65 "parsetiger.yy"
...
#line 2780 "libparse.hh"


#endif // !YY_PARSE_LIBPARSE_HH_INCLUDED
