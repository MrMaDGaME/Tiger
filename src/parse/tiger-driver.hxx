...
namespace parse
{
    ...
    TigerDriver::make_MethodCallExp(const location& location, misc::symbol name,
                                    ast::exps_type* args,
    ...
    TigerDriver::make_SubscriptVar(const location& location, ast::Var* var,
                                   ast::Exp* index) const
    {
    ...
    TigerDriver::make_FunctionDec(const location& location, misc::symbol name,
                                  ast::VarChunk* formals, ast::NameTy* result,
                                  ast::Exp* body) const
    {
