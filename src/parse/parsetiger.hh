    ...
    public:
        ...
        struct symbol_kind
        {
            enum symbol_kind_type
            {
                ...
                S_exps = 57, // exps
                S_exp = 58, // exp
                S_array_r = 59, // array_r
                S_function_r = 60, // function_r
                S_lvalue = 61, // lvalue
                S_chunks = 62, // chunks
                S_varchunk = 63, // varchunk
                S_funchunk = 64, // funchunk
                S_vardec = 65, // vardec
                S_fundec = 66, // fundec
                S_tychunk = 67, // tychunk
                S_tydec = 68, // tydec
                S_ty = 69, // ty
                S_tyfields = 70, // tyfields
                S_71_tyfields_1 = 71, // tyfields.1
                S_tyfield = 72, // tyfield
                S_typeid = 73 // typeid
            };
        };
