...
#line 140 "parse/parsetiger.hh"
    ...
    public:
        ...
        public:
            ...
            ///
            /// Both variants must be built beforehand, because swapping the
            /// actual data requires reading it (with as()), and this is not
            /// possible on unconstructed variants: it would require some
            /// dynamic testing, which should not be the variant's
            /// responsibility. Swapping between built and (possibly) non-built
            /// is done with self_type::move ().
            template <typename T>
        ...
        struct basic_symbol : Base
        {
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::ChunkList*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::ChunkList*& v,
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::Exp*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::Exp*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::Field*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::Field*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::FunctionChunk*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            ...
            basic_symbol(typename Base::kind_type t,
                         const ast::FunctionChunk*& v, const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
            {}
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::FunctionDec*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::FunctionDec*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::NameTy*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::NameTy*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::Ty*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::Ty*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::TypeChunk*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::TypeChunk*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::TypeDec*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::TypeDec*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::Var*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::Var*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::VarChunk*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::VarChunk*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::VarDec*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::VarDec*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::exps_type*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::exps_type*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::fieldinits_type*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
...
#else
            basic_symbol(typename Base::kind_type t,
                         const ast::fieldinits_type*& v, const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
            {}
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, ast::fields_type*&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const ast::fields_type*& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#if 201103L <= YY_CPLUSPLUS
            basic_symbol(typename Base::kind_type t, misc::symbol&& v,
                         location_type&& l)
                : Base(t)
                , value(std::move(v))
                , location(std::move(l))
            {}
#else
            basic_symbol(typename Base::kind_type t, const misc::symbol& v,
                         const location_type& l)
                : Base(t)
                , value(v)
                , location(l)
...
#line 1258 "parse/parsetiger.hh"
...
#else
        static symbol_type make_STRING(const std::string& v,
                                       const location_type& l)
        {
...
#else
        static symbol_type make_ID(const misc::symbol& v,
                                   const location_type& l)
        {
        ...
        public:
            ...
            /// the number of tokens stored in YYARG.  If YYARG is null, return
            /// the number of expected tokens (guaranteed to be less than
            /// YYNTOKENS).
    ...
    public:
        ...
        /// \param yyval    Its semantic value.
        /// \param yyloc    Its location.
        void yy_symbol_print_(symbol_kind_type yykind, const value_type& yyval,
                              const location_type& yyloc) const;
