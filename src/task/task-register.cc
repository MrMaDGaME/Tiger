...
namespace task
{
    ...
    TaskRegister::register_task_(const Task &task)
    {
        ...
        if (it == modules_.end())
            it = modules_
                     .emplace(module_name, po::options_description(module_name))
                     .first;
    ...
    int TaskRegister::nb_of_task_to_execute_get()
    {
    ...
    void TaskRegister::resolve_dependencies(const Task &task)
    {
        ...
        const Task::deps_type dep_tasks =
    ...
    char *TaskRegister::parse_arg(int argc, char *argv[])
    {
        ...
        generic.add_options()("help,?", "Give this help list")(
            ...
            "version", "Print program version")("license",
